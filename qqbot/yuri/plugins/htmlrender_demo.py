...
from nonebot_plugin_htmlrender import text_to_pic, md_to_pic, template_to_pic, get_new_page
from .concurrent_utils import RateLimiter
import logging
import datetime
import asyncio
import base64
    ...
    try:
        ...
        if img_bytes:
            ...
            try:
                ...
                if not finished:
                    try:
                        await md_to_image_cmd.finish(f"{BOT_PREFIX}发送图片失败")
                        finished = True
                    except:
                        pass
    except Exception as e:
